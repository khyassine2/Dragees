...
const WHATSAPP_NUMBER = '212723919977';
const MESSAGE = encodeURIComponent(
  'Bonjour, je souhaite un devis pour mes fiançailles.',
);

/** Floating contact CTA — the primary channel for enquiries in Morocco. */
export const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="group fixed right-4 bottom-4 z-80 flex items-center justify-center gap-3 rounded-full bg-[#1f8a52] p-3.5 text-ivory shadow-[0_6px_24px_rgba(13,13,12,0.18)] transition-colors duration-300 hover:bg-[#186c40] sm:right-6 sm:bottom-6 sm:py-3.5 sm:pr-5 sm:pl-4"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden
